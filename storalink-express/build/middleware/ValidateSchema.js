...
exports.Schemas = {
    ...
    folder: {
        create: joi_1.default.object({
            ...
            folderDescription: joi_1.default.string(),
    ...
    link: {
        create: joi_1.default.object({
            ...
            linkUrl: joi_1.default.string().required(),
            imageUrl: joi_1.default.string(),
            parentFolderId: joi_1.default.string().required(),
            description: joi_1.default.string(),
            iconUrl: joi_1.default.string().allow(""),
        }),
    },
};
